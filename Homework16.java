public class Homework16 {
	...
	public static int problem3(int[] arr) {
		...
		int firstHalf = problem3(arr, 0, middle);
		int secondHalf = problem3(arr, middle, arr.length);
	...
	//helper method... finds the minumum value of a section of the array
	 ...
	 */
	 public static int problem5(int bunnies) {
		 ...
		 else if(bunnies % 2 == 0){ //if it is even -- 2 ears
			 return 2 + problem5(bunnies - 1);
		 }
		 else{ //if it is odd -- 3 ears
